...
<h1 class="flex pl-4 pt-5 text-4xl font-semibold dark:text-white text-gray-800">Permuta</h1>
<!-- <div class="flex">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-700 dark:border-gray-700">
              <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <td class="py-4 px-6">
                 	<a href="/excluirpermuta?codigo=${permuta.getCodigo()}" class="remove-item border-0 focus:ring-red-500 focus:border-red-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-red-500">
