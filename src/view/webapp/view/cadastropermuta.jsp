...
<body class="bg-gray-50">
  ...
  <div class="ml-1 mr-3 w-1/2">
    <label class="block mb-2 text-sm font-medium text-black dark:text-gray-300 mt-4 ">Preço de Venda (R$)</label>
...
<div class="ml-1 mr-3 w-1/2">
  <label class="block mb-2 text-sm font-medium text-black dark:text-gray-300 mt-4 ">Valor do Crédito</label>
  ...
  <div class="flex">
    <div class="w-1/2 mr-1">
    <label class="block mb-2 text-sm font-medium text-black dark:text-gray-300 mt-4">Saldo em Crédito</label>
      ...
      <table class="w-full">
        <thead class="bg-gray-50 p-5  font-semibold p-4 sombra">
          <tr>
            ...
            <td class="p-4 ">Preço</td>
            <td class="p-4 ">Ações</td>
          </tr>
        </thead>
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" >
                  <div class="flex">
                    ...
                    <div class="ml-2">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Valor unitário</label>
    ...
    function validar(){
      ...
      var totalp = document.getElementById("totalp");
        ...
        if (valorcredito.value==''){
          ...
          notifier.show('Preencha o valor do crédito!', 'por favor, preencha o campo em vermelho na aba Pagamentos', 'warning', '/src/img/danger.png', 5000);
