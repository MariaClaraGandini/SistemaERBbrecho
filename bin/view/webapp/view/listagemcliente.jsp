...
<h1 class="flex pl-4 pt-5 text-4xl font-semibold text-gray-800 dark:text-white ">Clientes</h1>
<div class="flex">
<div class="pt-5 pl-4 flex w-full flexwrap">
<form class="relative pesquisar mr-3" method="GET" action="/pesquisarcliente">
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-700 dark:border-gray-700">
              <th class="px-3 w-1/4 font-normal  dark:text-white ">${cliente.getCodigo()}</th>
              <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <td class="py-4 px-6">
                  <a class="text-blue-500" href="/alterarcliente?codigo=${cliente.getCodigo()}">Editar</a> 
              </td>
                <td class="py-4 px-6">
                 	<a href="/excluircliente?codigo=${cliente.getCodigo()}" class="remove-item border-0 focus:ring-red-500 focus:border-red-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-red-500">
