...
<form class="relative pesquisar mr-3" method="GET" action="/pesquisarproduto">
  ...
  <button class=" ml-5 cadastrarbotao block  mb-2 p-2.5 w-full z-20 text-sm text-gray-900  rounded-lg border-l-gray-100 border-l-2 border border-gray-300 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:hover:cadastrarbotao">Adicionar Produto</button>
...
<div class="overflow-x-auto relative pl-1 pt-5">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-base text-gray-700 bg-gray-50 dark:bg-gray-800 dark:text-gray-400">
            <tr>
              <th class="px-3 w-1/4 font-semibold dark:text-white ">Código</th>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-700 dark:border-gray-700">
              <th class="px-3 w-1/4 font-normal  dark:text-white ">${produto.getCodigo()}</th>
              <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <td class="py-4 px-6">
                  <a class="text-blue-500" href="/alterarproduto?codigo=${produto.getCodigo()}">Editar</a> 
              </td>
                <td class="py-4 px-6">
                 	<a href="/excluirproduto?codigo=${produto.getCodigo()}" class="remove-item border-0 focus:ring-red-500 focus:border-red-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-red-500">
